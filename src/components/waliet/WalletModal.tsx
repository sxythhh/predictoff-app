...
function MetaMaskIcon() {
  return <img src="/images/metamask.svg" alt="MetaMask" width={28} height={28} className="rounded-lg" />;
}

function WalletConnectIcon() {
  return <img src="/images/walletconnect.svg" alt="WalletConnect" width={28} height={28} className="rounded-lg" />;
}

function CoinbaseIcon() {
  return <img src="/images/coinbase.svg" alt="Coinbase" width={28} height={28} className="rounded-lg" />;
}
